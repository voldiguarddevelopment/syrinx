...
GROUP_cue="control_survey_gate claude_md_invariant_gate cue_token_alignment prosody_cue_overrides expressive_api cue_activation_gate cue_activation_measure instruct_phrases"
...
OPT_IN_TESTS="real_cue_activation real_qwen_greedy_parity real_fish_s2_batch_parity real_qwen_serve real_qwen_eval real_qwen_seed real_qwen_affect real_emotion2vec"
